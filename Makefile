...
cliente:
	$(CXX) $(CLIENTE)/$(CLIENTE).cpp $(CLIENTE)/$(LIBRERIAS) $(CLIENTE)/$(OTRAS5) $(CLIENTE)/$(OTRAS3) $(CLIENTE)/$(OTRAS10) $(CLIENTE)/$(OTRAS11) $(CLIENTE)/$(OTRAS15) $(CLIENTE)/$(OTRAS16) $(CXXFLAGS) -o $(CLIENTE)/cliente

servidor:
	$(CXX) $(SERVIDOR)/$(SERVIDOR).cpp $(SERVIDOR)/$(LIBRERIAS) $(SERVIDOR)/$(OTRAS) \
	$(SERVIDOR)/$(OTRAS1) $(SERVIDOR)/$(OTRAS4) $(SERVIDOR)/$(OTRAS6) $(SERVIDOR)/$(OTRAS7) $(SERVIDOR)/$(OTRAS8) $(SERVIDOR)/$(OTRAS9) $(SERVIDOR)/$(OTRAS12) $(SERVIDOR)/$(OTRAS13) $(SERVIDOR)/$(OTRAS14) $(SERVIDOR)/$(OTRAS17) $(SERVIDOR)/$(OTRAS18) $(CXXFLAGS) -o $(SERVIDOR)/servidor
